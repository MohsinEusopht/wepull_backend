...
module.exports = {
    ...
    addXeroExpense:(expense_id,line_item, created_at, updated_at, txn_date, entity_ref_number, entity_ref_name, currency, payment_type, account_number, credit, description, department_id, location_id, total_amount, tax, is_paid, payment_ref_number, paid_amount, payment_date, company_id, user_id) => {
        return new Promise((resolov, reject) => {
            pool.query(
                `INSERT INTO expenses(expense_id, line_item, created_at, updated_at, txn_date, entity_ref_number, entity_ref_name, currency, payment_type, account_number, credit, description, department_id, location_id, total_amount, tax, is_paid, payment_ref_number, paid_amount, payment_date, company_id, user_id, company_type) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'xero')`, [expense_id, line_item, created_at, updated_at, txn_date, entity_ref_number, entity_ref_name, currency, payment_type, account_number, credit, description, department_id, location_id, total_amount, tax, is_paid, payment_ref_number, paid_amount, payment_date, company_id, user_id],
                (error, results, fields) => {
                    if (error) {
                        console.log(error);
                        return reject(error);
    ...
    updateXeroExpense:(expense_id,line_item , created_at, updated_at, txn_date, entity_ref_number, entity_ref_name, currency, payment_type, account_number, credit, description, department_id, location_id, total_amount, tax, is_paid, payment_ref_number, paid_amount, payment_date, company_id, user_id) => {
        return new Promise((resolov, reject) => {
            pool.query(
                `UPDATE expenses SET created_at = ?,updated_at = ?, txn_date = ?, entity_ref_number = ?, entity_ref_name = ?, currency = ?, payment_type = ?, account_number = ?, credit = ?, description = ?, department_id = ?, location_id = ?, total_amount = ?, tax = ?, is_paid = ?, payment_ref_number = ?, paid_amount = ?, payment_date = ?  WHERE expense_id = ? and line_item = ? and company_type = 'xero'`, [created_at,updated_at, txn_date, entity_ref_number, entity_ref_name, currency, payment_type, account_number, credit, description, department_id, location_id, total_amount, tax, is_paid, payment_ref_number, paid_amount, payment_date, expense_id, line_item],
                (error, results, fields) => {
                    if (error) {
                        console.log(error);
                        return reject(error);
